...
class Laplace_Noise_1D(Virtual_Noise_1D):
    def __init__(self, eps, sensitivity = None, truncation_at=10, granularity=100, scale=1):
        ...
        """
        super(Laplace_Noise_1D, self).__init__(eps, sensitivity=sensitivity, truncation_at=truncation_at, granularity=granularity, scale=scale, target_distribution=laplace)


class Laplace_Noise_1D_mechanism(Virtual_Noise_1D_mechanism):
    """
    This class returns the Laplace_Noise_1D distribution applied to a two delta mechanism M:
    ...
    def __init__(self, mean_diff, eps, truncation_at=10, granularity=100, scale=1):
        super(Laplace_Noise_1D_mechanism, self).__init__(mean_diff, eps, truncation_at=truncation_at, granularity=granularity, scale=scale, target_distribution=laplace)


if __name__ == "__main__":
    truncation_at = 10
    granularity = 3
    noise = Laplace_Noise_1D(eps=1, sensitivity=None, truncation_at=truncation_at, granularity=granularity)
